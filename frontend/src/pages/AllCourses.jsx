...
function AllCourses() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      <Nav />
      <button
        className="fixed top-20 left-4 z-50 bg-white text-balck px-3 py-1 rounded md:hidden border-2 border-black"
      ...
      {/* sideBar */}
      <aside
        className={`w-[260px] h-screen overflow-y-auto bg-black fixed top-0 left-0 p-6 py-[130px] border-r border-gray-200 shadow-md transition-transform duration-300 z-5 ${isSiderbarVisible ? "translate-x-0" : "-translate-x-full"} md:block md:translate-x-0`}
      >
