     ...
     <div className='bg-[#dddbdb] w-[100vw] h-[100vh] flex items-center justify-center'>
       <form className='w-[90%] md:w-200 h-150 bg-[white] shadow-xl rounded-2xl flex relative' onSubmit={(e) =>e.preventDefault()}>
         ...
         <div className='mid:w-[50%] w-[100%] h-[100%] flex flex-col items-center justify-center gap-3'>
           ...
           <button type='button' className='w-[80%] h-[40px] bg-black text-white cursor-pointer flex items-center justify-center rounded-[5px]' onClick={handleLogin} disabled={loading}>{loading ? <ClipLoader size={30} color='white'/> : "login"} </button>
