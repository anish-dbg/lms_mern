                ...
                <tbody>
                    ...
                    <tr key={index} className='border-b hover:bg-gray-50 transition duration-200'>
                        <td className='py-3 px-4 flex items-center gap-4'>
                            {course?.thumbnail?<img src={course?.thumbnail} className='w-25 h-14 object-cover rounded-md' alt="img" />:<img src={img} className='w-25 h-14 object-cover rounded-md' alt="img" />}
          ...
          <div className='md:hidden space-y-4 mt-3'>
           {creatorCourseData?.map((course,index) =>(
            ...
            <div className='flex gap-4 items-center mt-4'>
              {  course?.thumbnail?<img src={course?.thumbnail} className='w-16 h-16 rounded-md object-cover' alt="img"/>:
                <img src={img} className='w-16 h-16 rounded-md object-cover' alt="img"/>}
