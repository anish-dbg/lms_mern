    ...
    <div className='min-h-screen bg-gray-100 flex items-center justify-center p-4'>
        <div className='bg-white shadow-xl rounded-xl w-full max-w-2xl p-6'>
            ...
            <div className='mb-6'>
                ...
                <p className='text-sm text-gray-500'>Enter the title and your video lectures to enhance your course content.</p>
            </div>
            {/* input */}
            ...
            <div className='flex gap-4 mb-6'>
                <button className='flex items-center gap-2 px-4 py-2 rounded-md bg-gray-200 hover:bg-gray-300 text-sm font-medium cursor-pointer'><FaArrowLeftLong onClick={()=> navigate(`/editcourse/${courseId}`)}/>Back to Course</button>
