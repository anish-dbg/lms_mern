      ...
      <div className="max-w-6xl mx-auto bg-white shadow-md rounded-xl p-6 space-y-6 relative">
        ...
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1 space-y-2 mt-[20px]">
            ...
            <div className="flex items-start flex-col justify-between">
              ...
              <div>
                <span className="text-xl font-semi-bold text-black">
            ...
            <div className="flex flex-col gap-3">
              {selectedCourse?.lectures?.map((lecture, index) => (
                <button
                  ...
                  className={`flex items-center gap-3 w-full px-4 py-3 rounded-lg border transition-all duration-200 text-left
              ${
        ...
        <div className="mt-8 border-t pt-6">
          ...
          <div className="mb-4">
            ...
            disabled={loading} onClick={handleReview}> {loading? <ClipLoader color="white" size={30}/>:
             " Submit Review"
            }
            </button>
          </div>
