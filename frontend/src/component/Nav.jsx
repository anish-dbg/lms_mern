      ...
      <div className="w-[100%] h-[70px] fixed top-0 px-[20px] py=-[10px] flex items-center justify-between bg-[#00000047] z-10">
        ...
        <div className="w-[30%] lg:flex items-center justify-center gap-4 hidden">
          ...
          {!userData ? (
            ...
            <span
              className="px-[20px] py-[10px] border-2 bg-white text-black rounded-[10px] text-[18px] shadow-sm cursor-pointer "
        ...
        >
          ...
          <div
            className="w-[200px] h-[65px] border-2 border-white text-white bg-[black] rounded-[10px] flex items-center justify-center text-[18px] font-light cursor-pointer"
            onClick={() => navigate("/profile")}
          >
            My Profile
          </div>
